...
${OBJECTDIR}/ListaCircular.o: ListaCircular.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListaCircular.o ListaCircular.cpp

${OBJECTDIR}/ListaDoble.o: ListaDoble.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListaDoble.o ListaDoble.cpp
